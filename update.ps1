...
Get-ChildItem -Recurse -Path .\bucket | ForEach-Object -Process {
    ...
    # GitHub Releases
    $content = $content -replace '(https?://github\.com/.+/releases/.*download)', 'https://github.sd9.me/$1'

    # GitHub Archive
    $content = $content -replace '(https?://github\.com/.+/archive/)', 'https://github.sd9.me/$1'

    # GitHub Gists
    $content = $content -replace '(https?://gist.github\.com/.+/)', 'https://github.sd9.me/$1'

    # GitHub Raw
    $content = $content -replace '(https?://raw\.githubusercontent\.com)', 'https://github.sd9.me/$1'
    $content = $content -replace '(https?://github\.com/.+/raw/)', 'https://github.sd9.me/$1'         

    # DBeaver，not debaver-ea
    $content = $content -replace 'https?://dbeaver\.io/files/([\d\.]+)/', 'https://github.sd9.me/https://github.com/dbeaver/dbeaver/releases/download/$1/'
    
    # FastCopy
    $content = $content -replace 'https?://fastcopy\.jp/archive', 'https://github.sd9.me/https://raw.githubusercontent.com/FastCopyLab/FastCopyDist2/main'

    # OBS Studio
    $content = $content -replace 'https?://cdn-fastly\.obsproject\.com/downloads/OBS-Studio-(.+)-Windows\.zip', 'https://github.sd9.me/https://github.com/obsproject/obs-studio/releases/download/$1/OBS-Studio-$1-Windows.zip'

    # OBS Studio 2.7
    $content = $content -replace 'https?://cdn-fastly\.obsproject\.com/downloads/OBS-Studio-(.+)-Full', 'https://github.sd9.me/https://github.com/obsproject/obs-studio/releases/download/$1/OBS-Studio-$1-Full'

    # Strawberry
    $content = $content -replace 'https?://files\.jkvinge\.net/packages/strawberry/StrawberrySetup-(.+)-mingw-x', 'https://github.sd9.me/https://github.com/strawberrymusicplayer/strawberry/releases/download/$1/StrawberrySetup-$1-mingw-x'
